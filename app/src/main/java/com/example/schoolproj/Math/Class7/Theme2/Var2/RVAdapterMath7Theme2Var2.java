...
public class RVAdapterMath7Theme2Var2 extends RecyclerView.Adapter<RVAdapterMath7Theme2Var2.ViewHolder> {

    private List<String> mData;
    private LayoutInflater mInflater;
    private RVAdapterMath7Theme2Var2.ItemClickListener mClickListener;
    private Context mContext;

    RVAdapterMath7Theme2Var2(Context context, List<String> data) {
    ...
    @Override
    public RVAdapterMath7Theme2Var2.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.recyclerview_row, parent, false);
        return new RVAdapterMath7Theme2Var2.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(RVAdapterMath7Theme2Var2.ViewHolder holder, int position) {
    ...
    void setClickListener(RVAdapterMath7Theme2Var2.ItemClickListener itemClickListener) {
