...
public class MathClass7Theme2Var1Task2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_math_class7_theme2_var1_task2);
    }

    public void onAnswerClick(View view) {
        EditText editText = findViewById(R.id.answer);
        String answer = editText.getText().toString();
        if (answer.equals("c*1000+d*10")) {
    ...
    public void onNextClick(View view) {
        Intent intent = new Intent(MathClass7Theme2Var1Task2Activity.this, MathClass7Theme2Var1Task3Activity.class);
        startActivity(intent);
        finish();
    }

    public void onPrevClick(View view) {
        Intent intent = new Intent(MathClass7Theme2Var1Task2Activity.this, MathClass7Theme2Var1Task1Activity.class);
        startActivity(intent);
        finish();
    }
}