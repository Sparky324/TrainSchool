...
public class MathClass7Theme1Var1Task2Activity extends AppCompatActivity {
    ...
    public void onNextClick(View view) {
        Intent intent = new Intent(MathClass7Theme1Var1Task2Activity.this, MathClass7Theme1Var1Task3Activity.class);
        startActivity(intent);
        finish();
    }

    public void onPrevClick(View view) {
        Intent intent = new Intent(MathClass7Theme1Var1Task2Activity.this, MathClass7Theme1Var1Task1Activity.class);
        startActivity(intent);
        finish();
    }
}